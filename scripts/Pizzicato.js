!(function (e) {
  ...
  function i() {
      ...
      this.reverbNode.buffer &&
          (this.inputNode.disconnect(this.reverbNode), this.reverbNode.disconnect(this.wetGainNode), (this.reverbNode = o.context.createConvolver()), this.inputNode.connect(this.reverbNode), this.reverbNode.connect(this.wetGainNode)),
  ...
  h.connect(o.context.destination),
      (o.Util = {
          ...
          getDryLevel: function (e) {
              return !s.Util.isNumber(e) || e > 1 || 0 > e ? 0 : 0.5 >= e ? 1 : 1 - 2 * (e - 0.5);
          },
          getWetLevel: function (e) {
              return !s.Util.isNumber(e) || e > 1 || 0 > e ? 0 : e >= 0.5 ? 1 : 1 - 2 * (0.5 - e);
          },
      });
  ...
  (d.connect = function (e) {
      ...
      (o.Sound = function (e, t) {
          ...
          function r(e, t) {
              ...
              navigator.mediaDevices.getUserMedia ? navigator.mediaDevices.getUserMedia({ audio: !0 }).then(i)["catch"](n) : navigator.getUserMedia({ audio: !0 }, i, n);
          }
          function c(e, t) {
          ...
          (this.detached = f && e.options.detached),
              ...
              f && d.isNumber(e.options.release)
                  ...
                  ? (console.warn("'sustain' is deprecated. Use 'release' instead."), (this.release = e.options.sustain))
                  : (this.release = v),
              e
                  ? d.isString(e)
                      ? a.bind(this)(e, t)
      ...
      (o.Sound.prototype = Object.create(o.Events, {
          play: {
              ...
              value: function (e, t) {
                  this.playing ||
                      ...
                      this.applyAttack(),
                      s.Util.isFunction(this.sourceNode.start) && ((this.lastTimePlayed = o.context.currentTime - t), this.sourceNode.start(s.context.currentTime + e, t)),
                      this.trigger("play"));
              },
          },
          stop: {
              ...
              value: function () {
                  if (this.sourceNode) {
                      ...
                      e.gainSuccessor.gain.setValueAtTime(e.gainSuccessor.gain.value, s.context.currentTime),
                          e.gainSuccessor.gain.linearRampToValueAtTime(1e-4, s.context.currentTime + 0.2),
                          setTimeout(function () {
          ...
          applyAttack: {
              ...
              value: function () {
                  ...
                  if ((this.fadeNode.gain.cancelScheduledValues(s.context.currentTime), !this.attack)) return void this.fadeNode.gain.setTargetAtTime(1, s.context.currentTime, 0.001);
          ...
          stopWithRelease: {
              ...
              value: function (e) {
                  ...
                  this.fadeNode.gain.value;
                  if ((this.fadeNode.gain.cancelScheduledValues(s.context.currentTime), !this.release)) return this.fadeNode.gain.setTargetAtTime(0, s.context.currentTime, 0.001), void i();
              ...
              value: function (e) {
                  return s.Util.isSound(e)
                      ? this.sounds.indexOf(e) > -1
                          ? void console.warn("The Pizzicato.Sound object was already added to this group")
                          : e.detached
                          ? void console.warn("Groups do not support detached sounds. You can manually create an audio graph to group detached sounds together.")
                          : (e.disconnect(s.masterGainNode), e.connect(this.mergeGainNode), void this.sounds.push(e))
  ...
  (o.Effects.Delay = function (e) {
      ...
      (o.Effects.Compressor = function (e) {
          (this.options = {}), (e = e || this.options);
          var t = { threshold: -24, knee: 30, attack: 0.003, release: 0.25, ratio: 12 };
  ...
  (o.Effects.LowPassFilter.prototype = p),
      ...
      (o.Effects.Flanger.prototype = Object.create(f, {
          time: {
              ...
              set: function (e) {
                  s.Util.isInRange(e, 0, 1) && ((this.options.time = e), (this.delayNode.delayTime.value = s.Util.normalize(e, 0.001, 0.02)));
              },
          },
          speed: {
              enumberable: !0,
              ...
              set: function (e) {
                  s.Util.isInRange(e, 0, 1) && ((this.options.speed = e), (this.oscillatorNode.frequency.value = s.Util.normalize(e, 0.5, 5)));
              },
          },
          depth: {
              enumberable: !0,
              ...
              set: function (e) {
                  s.Util.isInRange(e, 0, 1) && ((this.options.depth = e), (this.gainNode.gain.value = s.Util.normalize(e, 5e-4, 0.005)));
              },
          },
          feedback: {
              enumberable: !0,
              ...
              set: function (e) {
                  s.Util.isInRange(e, 0, 1) && ((this.options.feedback = e), (this.feedbackNode.gain.value = s.Util.normalize(e, 0, 0.8)));
              },
          },
          mix: {
              enumberable: !0,
      ...
      (o.Effects.StereoPanner = function (e) {
          ...
          (this.inputNode = o.context.createGain()),
              ...
              o.context.createStereoPanner
                  ? ((this.pannerNode = o.context.createStereoPanner()), this.inputNode.connect(this.pannerNode), this.pannerNode.connect(this.outputNode))
                  : o.context.createPanner
                  ...
                  : (console.warn("Your browser does not support the Panner effect."), this.inputNode.connect(this.outputNode));
          for (var i in t) (this[i] = e[i]), (this[i] = void 0 === this[i] || null === this[i] ? t[i] : this[i]);
      }),
  ...
  return (
      ...
      (v.prototype.setCurve = function () {
          var e, t, i, n, o, s, a, r;
          for (t = 1024, o = new Float32Array(t), e = s = 0, a = o.length; a >= 0 ? a > s : s > a; e = a >= 0 ? ++s : --s)
              (i = (e - t / 2) / (t / 2)),
                  (i = Math.abs(i)),
                  (n =
                      i <= this.vb
                          ? 0
                          : this.vb < i && i <= this.vl
                          ? this.h * (Math.pow(i - this.vb, 2) / (2 * this.vl - 2 * this.vb))
                          : this.h * i - this.h * this.vl + this.h * (Math.pow(this.vl - this.vb, 2) / (2 * this.vl - 2 * this.vb))),
                  (o[e] = n);
